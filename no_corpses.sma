...
{
    // Register before map entities spawn so turrets can be removed immediately.
 ...
 *
 * Removes map-created turret and miniturret entities before their normal
 * spawn initialization runs. This is always enabled and has no cvar.
 */
public fw_EntitySpawn_Pre(ent)
{
    ...
    if (equal(classname, "monster_turret")
